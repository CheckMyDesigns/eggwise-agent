...
care_agent = Agent(
    ...
    instruction=(
        ...
        "4. To write a check-in for a patient, call queue_checkin with the patient id; it drafts a "
        "personalized check-in that appears as an editable draft in the chat (and is saved in the "
        "Outbox). Briefly invite the clinician to edit and send it here or in the Outbox; do not paste "
        "the full message text yourself.\n"
